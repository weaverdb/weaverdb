 ...
 * @author  mscott
 */
public class WeaverRunningResultSet implements ResultSet {
    HashMap map;
    List rows;
    int position;
    Weaver connection;
    ...
    public WeaverRunningResultSet(List items, WeaverStatement st, WeaverResultSetMetaData md) throws SQLException {
        meta_data = md;
        statement = st;
        map = new HashMap();
  ...
  /*  this flattens results into a 2d array  */  
    ...
    public WeaverRunningResultSet(Object[] base, WeaverHeader header) throws SQLException {
    ...
    public boolean next() throws SQLException {
        ...
        if ( position == rows.size() ) {
            List new_rows = statement.getEntireResults(fetch_cap);
            position = 0;
            rows = new_rows;
            return ( new_rows.size() != 0 );
