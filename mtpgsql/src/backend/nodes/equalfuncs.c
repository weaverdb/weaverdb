 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/nodes/equalfuncs.c,v 1.1.1.1 2006/08/12 00:20:41 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#include <string.h>
...
static bool
_equalDelegatedIndexScan(DelegatedIndexScan *a, DelegatedIndexScan *b)
{
...
equal(void *a, void *b)
{
	...
	switch (nodeTag(a))
	{
		...
		case T_DelegatedIndexScan:
			retval = _equalDelegatedIndexScan(a, b);
			break;
		case T_TidScan:
