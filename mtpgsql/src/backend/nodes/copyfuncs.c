 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/nodes/copyfuncs.c,v 1.1.1.1 2006/08/12 00:20:41 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#include <string.h>
...
/* ----------------
 *		_copyDelegatedSeqScan
 * ----------------
 */
static DelegatedSeqScan *
_copyDelegatedSeqScan(DelegatedSeqScan *from)
{
	DelegatedSeqScan    *newnode = makeNode(DelegatedSeqScan);
	...
	CopyPlanFields((Plan *) from, (Plan *) newnode);
	CopyScanFields((Scan *) from, (Scan *) newnode);
        elog(ERROR,"check _copyDelegatedSeqScan implementation");
	return newnode;
}
...
_copyDelegatedIndexScan(DelegatedIndexScan *from)
{
	DelegatedIndexScan  *newnode = makeNode(DelegatedIndexScan);
...
copyObject(void *from)
{
	...
	switch (nodeTag(from))
	{
		...
		case T_DelegatedSeqScan:
			retval = _copyDelegatedSeqScan(from);
			break;
		case T_IndexScan:
			retval = _copyIndexScan(from);
			break;
		case T_DelegatedIndexScan:
			retval = _copyDelegatedIndexScan(from);
			break;
		case T_TidScan:
