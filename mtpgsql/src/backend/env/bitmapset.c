...
bms_make_singleton(long x)
{
	...
	result = (Bitmapset *) palloc(BITMAPSET_SIZE(wordnum + 1));
        memset(result,0x00,BITMAPSET_SIZE(wordnum + 1));
 ...
 */
bool
bms_is_member(long x, const Bitmapset *a)
{
	long			wordnum,
				bitnum;
 ...
 */
Bitmapset *
bms_add_member(Bitmapset *a, long x)
{
	long			wordnum,
				bitnum;
 ...
 */
Bitmapset *
bms_del_member(Bitmapset *a, long x)
{
	long			wordnum,
				bitnum;
