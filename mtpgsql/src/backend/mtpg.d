...
provider mtpg {
	...
	probe initplan(int);
        ...
        probe file__closed(int, int, string);
        probe file__retired(int, string);
        probe file__activated(int, string);
        probe file__maxcheck(int, int);
        probe file__search(string, char, int);
