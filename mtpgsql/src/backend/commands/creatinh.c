 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/commands/creatinh.c,v 1.1.1.1 2006/08/12 00:20:19 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#include <string.h>
...
*/
	...
	relationId = heap_create_with_catalog(relname, descriptor, relkind, stmt->istemp);
	...
	/*
	 * Parse and add blob storage indications
	 */
	AddRelationStorageDirectives(rel, stmt->constraints);
	/*
