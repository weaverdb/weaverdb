...
rebuildheap(Oid OIDNewHeap, Oid OIDOldHeap, Oid OIDOldIndex)
{
	...
	while (index_getnext(ScanDesc, ForwardScanDirection))
	{
		HeapTupleData LocalHeapTuple;
		Buffer		LocalBuffer;

		LocalHeapTuple.t_self = ScanDesc->xs_ctup.t_self;
		LocalHeapTuple.t_datamcxt = NULL;
		LocalHeapTuple.t_datasrc = NULL;
		LocalHeapTuple.t_info = 0;
		...
		if (LocalHeapTuple.t_data != NULL) {
			...
			ReleaseBuffer(LocalOldHeap, LocalBuffer);
