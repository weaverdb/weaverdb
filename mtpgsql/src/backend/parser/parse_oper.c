 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/parser/parse_oper.c,v 1.1.1.1 2006/08/12 00:21:11 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
						   ...
						   CandidateList *candidates)
{
	...
	*candidates = NULL;
	...
	while (HeapTupleIsValid(tup = heap_getnext(pg_operator_scan)))
	{
