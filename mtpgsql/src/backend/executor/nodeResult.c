 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/executor/nodeResult.c,v 1.1.1.1 2006/08/12 00:20:34 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#include "postgres.h"
...
ExecInitResult(Result *node, EState *estate)
{
	 ...
	 * ----------------
	 */
	ExecAssignNodeBaseInfo(estate, &resstate->cstate);
...
void
ExecReScanResult(Result *node, ExprContext *exprCtxt)
{
