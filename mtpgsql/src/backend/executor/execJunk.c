 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/executor/execJunk.c,v 1.1.1.1 2006/08/12 00:20:26 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#include <string.h>
					 ...
					 bool *isNull)
{
	...
	*value = HeapGetAttr(tuple, resno, tupType, isNull);
...
ExecRemoveJunk(JunkFilter *junkfilter, TupleTableSlot *slot)
{
	...
	{
		values[i] = HeapGetAttr(tuple, cleanMap[i], tupType, &isNull);
