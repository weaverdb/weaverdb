 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/executor/nodeNestloop.c,v 1.1.1.1 2006/08/12 00:20:34 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
/*
...
ExecInitNestLoop(NestLoop *node, EState *estate)
{
	 ...
	 * ----------------
	 */
	ExecAssignNodeBaseInfo(estate, &nlstate->jstate);
 ...
 */
void
ExecReScanNestLoop(NestLoop *node, ExprContext *exprCtxt)
{
