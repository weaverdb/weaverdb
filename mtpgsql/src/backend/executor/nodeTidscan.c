 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/executor/nodeTidscan.c,v 1.1.1.1 2006/08/12 00:20:35 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
/*
 ...
 */
void
ExecTidReScan(TidScan *node, ExprContext *exprCtxt)
{
	EState	   *estate;
	TidScanState *tidstate;
	ItemPointer *tidList;
