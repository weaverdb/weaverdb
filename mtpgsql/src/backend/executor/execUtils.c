 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/executor/execUtils.c,v 1.1.1.1 2006/08/12 00:20:30 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
/*
 ...
 */
void
ExecAssignNodeBaseInfo(EState *estate, CommonState *cstate)
{
	int			baseId;
				...
				RelationInfo *resultRelationInfo)
{
	...
	while (HeapTupleIsValid(tuple = heap_getnext(indexSd)))
	{
