 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/optimizer/path/joinpath.c,v 1.1.1.1 2006/08/12 00:20:48 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#include <sys/types.h>
					 ...
					 List *restrictlist)
{
	 ...
	 */
	if (GetCostInfo()->enable_mergejoin)
	 ...
	 */
	if (GetCostInfo()->enable_hashjoin)
