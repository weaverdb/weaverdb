 ...
 *
 * $Id: geqo_main.c,v 1.1.1.1 2006/08/12 00:20:44 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
...
/* set GA parameters */
	...
	number_generations = env->Generations;
	status_interval = 10;

/* seed random number generator */
	sprandom(env->RandomSeed);
...
/* iterative optimization */
	...
	for (generation = 0; generation < number_generations; generation++)
	{
		...
		/* SELECTION */
		geqo_selection(momma, daddy, pool, env->SelectionBias);		/* using linear bias
																 * function */
