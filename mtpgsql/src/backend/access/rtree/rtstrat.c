 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/access/rtree/rtstrat.c,v 1.1.1.1 2006/08/12 00:20:05 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
...
static StrategyExpression RTEvaluationExpressions[] = {
