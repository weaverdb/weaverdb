 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/access/index/istrat.c,v 1.1.1.1 2006/08/12 00:20:00 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
								 ...
								 ScanKey entry)
{
	...
	else
	{
		...
		scan = heap_beginscan(operatorRelation, SnapshotNow,
							  1, &scanKeyData);
