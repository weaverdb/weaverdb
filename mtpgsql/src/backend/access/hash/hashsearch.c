 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/access/hash/hashsearch.c,v 1.1.1.1 2006/08/12 00:19:58 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
...
_hash_next(IndexScanDesc scan, ScanDirection dir)
{
	...
	{
            so->hashso_curbuf = _hash_getbuf(rel,ItemPointerGetBlockNumber(current),HASH_READ);
	}
