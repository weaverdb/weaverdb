 ...
 *
 * IDENTIFICATION
 *	  $Header: /cvs/weaver/mtpgsql/src/backend/postmaster/postmaster.c,v 1.1.1.1 2006/08/12 00:21:17 synmscott Exp $
 *
 * NOTES
 *
 * Initialization:
...
PostmasterMain(int argc, char *argv[])
{
	...
	*original_extraoptions = '\0';
	...
	InitSystem(true);    /*  this is a multibackend system but should never be called */
...
PostmasterRandom(void)
{
	...
	if (!initialized)
	{
		sprandom(random_seed);
		initialized = true;
	}

	return prandom() ^ random_seed;
}
