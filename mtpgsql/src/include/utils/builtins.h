...
PG_EXTERN int32 connectortoint4(int32);
PG_EXTERN int32 int4toconnector(int32);
...
PG_EXTERN int32 btconnectorcmp(int32 a, int32 b);
...
PG_EXTERN int32 byteacmp(bytea *arg1, bytea *arg2);
...
PG_EXTERN bytea* sha2(struct varlena* src);
