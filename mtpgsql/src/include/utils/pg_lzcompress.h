 ...
 * pg_lzcompress.h -
 *
 * $Header: /cvs/weaver/mtpgsql/src/include/utils/pg_lzcompress.h,v 1.1.1.1 2006/08/12 00:22:27 synmscott Exp $
 *
 ...
 * ----------
 */
PG_EXTERN PGLZ_Strategy *PGLZ_strategy_default;
PG_EXTERN PGLZ_Strategy *PGLZ_strategy_allways;
PG_EXTERN PGLZ_Strategy *PGLZ_strategy_never;
 ...
 * ----------
 */
PG_EXTERN int	pglz_get_next_decomp_char_from_lzdata(PGLZ_DecompState *dstate);
PG_EXTERN int	pglz_get_next_decomp_char_from_plain(PGLZ_DecompState *dstate);
