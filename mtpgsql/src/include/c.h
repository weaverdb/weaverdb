 ...
 *
 * $Id: c.h,v 1.1.1.1 2006/08/12 00:22:06 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
/*
...
#define GET_4_BYTES(datum)	(((Datum) (datum)) & 0x00000000ffffffff)
#define GET_8_BYTES(datum)	(((Datum) (datum)) & 0xffffffffffffffff)
#define SET_1_BYTE(value)	(((Datum) (value)) & 0x00000000000000ff)
#define SET_2_BYTES(value)	(((Datum) (value)) & 0x000000000000ffff)
#define SET_4_BYTES(value)	(((Datum) (value)) & 0x00000000ffffffff)
...
#define DatumGetInt64(X) ((long) GET_8_BYTES(X))
...
#define DatumGetUInt64(X) ((unsigned long) GET_8_BYTES(X))
...
#define LongGetDatum(X) ((long)SET_8_BYTES(X))
#define ULongGetDatum(X) ((unsigned long)SET_8_BYTES(X))
#define DatumGetLong(X) ((long) GET_8_BYTES(X))
#define DatumGetULong(X) ((unsigned long) GET_8_BYTES(X))
 ...
 */
#define DatumGetObjectId(X) ((Oid) GET_8_BYTES(X))
/*
 * ObjectIdGetDatum
 *		Returns datum representation for an object identifier.
 */
#define ObjectIdGetDatum(X) ((Datum) SET_8_BYTES(X))

#else

#define LongGetDatum(X) ((long)SET_4_BYTES(X))
#define ULongGetDatum(X) ((unsigned long)SET_4_BYTES(X))
#define DatumGetLong(X) ((long) GET_4_BYTES(X))
#define DatumGetULong(X) ((unsigned long) GET_4_BYTES(X))
...
#define TrapMacro(condition, exception) \
	((bool) ((! assert_enabled) || ! (condition) || \
			 (ExceptionalCondition(CppAsString(condition), \
								  &(exception), \
								  (char*) NULL, __FILE__, __LINE__))))
#ifndef SELECTIVE_ASSERT_CHECKING
    #define SelectiveAssert(condition) \
 ...
 */
 ...
 #define TYPEALIGN(ALIGNVAL,LEN) (((Size)(LEN) + (ALIGNVAL-1)) & ~(ALIGNVAL-1))
