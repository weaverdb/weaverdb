...
PG_EXTERN HeapTuple AmNameIndexScan(Relation heapRelation,...);
...
PG_EXTERN HeapTuple ClassNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ClassNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ClassOidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ExtStoreAttnumIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple GroupNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple GroupSysidIndexScan(Relation heapRelation,...);
extern HeapTuple IndexRelidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple InheritsRelidSeqnoIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple LanguageNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple LanguageOidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ListenerRelnamePidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple OpclassDeftypeIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple OpclassNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple OperatorNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple OperatorOidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ProcedureNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ProcedureOidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple RewriteOidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple RewriteRulenameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ShadowNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple ShadowSysidIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple StatisticRelidAttnumIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple TypeNameIndexScan(Relation heapRelation,...);
PG_EXTERN HeapTuple TypeOidIndexScan(Relation heapRelation,...);
