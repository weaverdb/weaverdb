 ...
 *
 * $Id: pg_statistic.h,v 1.1.1.1 2006/08/12 00:22:16 synmscott Exp $
 *
 * NOTES
...
CATALOG(pg_statistic)
{
	 ...
	 */
	wrapped		stacommonval;	/* most common non-null value in column */
	wrapped		staloval;		/* smallest non-null value in column */
	wrapped		stahival;		/* largest non-null value in column */
