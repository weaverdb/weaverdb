...
DATA(insert OID = 0 (  403 1419	1689 1 ));
DATA(insert OID = 0 (  403 1419	1698 2 ));
DATA(insert OID = 0 (  403 1419	1630 3 ));
DATA(insert OID = 0 (  403 1419	1699 4 ));
DATA(insert OID = 0 (  403 1419	1697 5 ));

/*
 *	nbtree java_ops
 */
DATA(insert OID = 0 (  403 1989	2002 1 ));
DATA(insert OID = 0 (  403 1989	2004 2 ));
 ...
 */
DATA(insert OID = 0 (  2397 1991 2301 1 ));

/*
 *	ivfflat vector_ip_ops
 */
DATA(insert OID = 0 (  2397 1992 2302 1 ));

/*
 *	ivfflat vector_cosine_ops
 */
DATA(insert OID = 0 (  2397 1993 2303 1 ));

/*
 *	hnsw vector_l2_ops
 */
DATA(insert OID = 0 (  2398 1991 2301 1 ));

/*
 *	hnsw vector_ip_ops
 */
DATA(insert OID = 0 (  2398 1992 2302 1 ));

/*
 *	hnsw vector_cosine_ops
 */
DATA(insert OID = 0 (  2398 1993 2303 1 ));

/*
 *	ivfflat halfvec_l2_ops
 */
DATA(insert OID = 0 (  2397 1995 2310 1 ));

/*
 *	ivfflat halfvec_ip_ops
 */
DATA(insert OID = 0 (  2397 1996 2311 1 ));

/*
 *	ivfflat halfvec_cosine_ops
 */
DATA(insert OID = 0 (  2397 1997 2312 1 ));

/*
 *	hnsw halfvec_l2_ops
 */
DATA(insert OID = 0 (  2398 1995 2310 1 ));

/*
 *	hnsw halfvec_ip_ops
 */
DATA(insert OID = 0 (  2398 1996 2311 1 ));

/*
 *	hnsw halfvec_cosine_ops
 */
DATA(insert OID = 0 (  2398 1997 2312 1 ));

/*
 *	hnsw sparsevec_l2_ops
 */
DATA(insert OID = 0 (  2398 1998 2321 1 ));

/*
 *	hnsw sparsevec_ip_ops
 */
DATA(insert OID = 0 (  2398 2400 2322 1 ));

/*
 *	hnsw sparsevec_cosine_ops
 */
DATA(insert OID = 0 (  2398 2020 2323 1 ));

/*
 *	ivfflat bit_hamming_ops
 */
DATA(insert OID = 0 (  2397 2021 2319 1 ));

/*
 *	hnsw bit_hamming_ops
 */
DATA(insert OID = 0 (  2398 2021 2319 1 ));

/*
 *	hnsw bit_jaccard_ops
 */
DATA(insert OID = 0 (  2398 2022 2320 1 ));

/*
 *	hnsw vector_l1_ops
 */
DATA(insert OID = 0 (  2398 2024 2376 1 ));

/*
 *	hnsw halfvec_l1_ops
 */
DATA(insert OID = 0 (  2398 2025 2377 1 ));

/*
 *	hnsw sparsevec_l1_ops
 */
DATA(insert OID = 0 (  2398 2026 2378 1 ));
#endif	 /* PG_AMOP_H */
