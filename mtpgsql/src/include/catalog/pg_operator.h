 ...
 *
 * $Id: pg_operator.h,v 1.1.1.1 2006/08/12 00:22:13 synmscott Exp $
 *
 * NOTES
...
DATA(insert OID =  1630 ( "="		   PGUID 0 b t t  1136  1136  16  1630 518  97  97 int4eq eqsel eqjoinsel ));
DATA(insert OID =  1713 ( "="		   PGUID 0 b t t  23  1136  16  1630 518  97  97 int4eq eqsel eqjoinsel ));
DATA(insert OID =  1714 ( "="		   PGUID 0 b t t  1136  23  16  1630 518  97  97 int4eq eqsel eqjoinsel ));
DATA(insert OID =  97 ( "<"		   PGUID 0 b t f  23  23  16 521 525   0   0 int4lt scalarltsel scalarltjoinsel ));
DATA(insert OID =  1689 ( "<"		   PGUID 0 b t f  1136  1136  16 1697 1699   0   0 int4lt scalarltsel scalarltjoinsel ));
DATA(insert OID =  1715 ( "<"		   PGUID 0 b t f  23  1136  16 1697 1699   0   0 int4lt scalarltsel scalarltjoinsel ));
DATA(insert OID =  1716 ( "<"		   PGUID 0 b t f  1136  23  16 1697 1699   0   0 int4lt scalarltsel scalarltjoinsel ));
...
DATA(insert OID = 493 (  "<<"	   PGUID 0 b t f 603 603  16   0   0   0   0 rect_left positionsel positionjoinsel ));
DATA(insert OID = 494 (  "&<"	   PGUID 0 b t f 603 603  16   0   0   0   0 rect_overleft positionsel positionjoinsel ));
DATA(insert OID = 495 (  "&>"	   PGUID 0 b t f 603 603  16   0   0   0   0 rect_overright positionsel positionjoinsel ));
DATA(insert OID = 496 (  ">>"	   PGUID 0 b t f 603 603  16   0   0   0   0 rect_right positionsel positionjoinsel ));
DATA(insert OID = 497 (  "@"	   PGUID 0 b t f 603 603  16 498   0   0   0 rect_contained contsel contjoinsel ));
DATA(insert OID = 498 (  "~"	   PGUID 0 b t f 603 603  16 497   0   0   0 rect_contain contsel contjoinsel ));
DATA(insert OID = 499 (  "~="	   PGUID 0 b t f 603 603  16 499   0   0   0 rect_same eqsel eqjoinsel ));
DATA(insert OID = 500 (  "&&"	   PGUID 0 b t f 603 603  16   0   0   0   0 rect_overlap areasel areajoinsel ));
DATA(insert OID = 501 (  ">="	   PGUID 0 b t f 603 603  16 505 504   0   0 rect_ge areasel areajoinsel ));
DATA(insert OID = 502 (  ">"	   PGUID 0 b t f 603 603  16 504 505   0   0 rect_gt areasel areajoinsel ));
DATA(insert OID = 503 (  "="	   PGUID 0 b t f 603 603  16 503   0 504 504 rect_eq eqsel eqjoinsel ));
DATA(insert OID = 504 (  "<"	   PGUID 0 b t f 603 603  16 502 501   0   0 rect_lt areasel areajoinsel ));
DATA(insert OID = 505 (  "<="	   PGUID 0 b t f 603 603  16 501 502   0   0 rect_le areasel areajoinsel ));
...
DATA(insert OID = 513 (  "@@"	   PGUID 0 l t f   0 603 600   0   0   0   0 rect_center - - ));
#endif
...
DATA(insert OID = 1696 (  "<>"	   PGUID 0 b t f  1136  1136  16 1696  96  0  0 int4ne neqsel neqjoinsel ));
DATA(insert OID = 1717 (  "<>"	   PGUID 0 b t f  23  1136  16 1696  96  0  0 int4ne neqsel neqjoinsel ));
DATA(insert OID = 1747 (  "<>"	   PGUID 0 b t f  1136  23  16 1696  96  0  0 int4ne neqsel neqjoinsel ));
...
DATA(insert OID = 1697 (  ">"	   PGUID 0 b t f  1136	1136  16  97 523  0  0 int4gt scalargtsel scalargtjoinsel ));
DATA(insert OID = 1748 (  ">"	   PGUID 0 b t f  23	1136  16  97 523  0  0 int4gt scalargtsel scalargtjoinsel ));
DATA(insert OID = 1749 (  ">"	   PGUID 0 b t f  1136	23  16  97 523  0  0 int4gt scalargtsel scalargtjoinsel ));
...
DATA(insert OID = 1698 (  "<="	   PGUID 0 b t f  1136	1136  16 1697 521  0  0 int4le scalarltsel scalarltjoinsel ));
DATA(insert OID = 1750 (  "<="	   PGUID 0 b t f  23	1136  16 1697 521  0  0 int4le scalarltsel scalarltjoinsel ));
DATA(insert OID = 1798 (  "<="	   PGUID 0 b t f  1136	23  16 1697 521  0  0 int4le scalarltsel scalarltjoinsel ));
...
DATA(insert OID = 1699 (  ">="	   PGUID 0 b t f  1136	1136  16 1698  97  0  0 int4ge scalargtsel scalargtjoinsel ));
DATA(insert OID = 1799 (  ">="	   PGUID 0 b t f  23	1136  16 1698  97  0  0 int4ge scalargtsel scalargtjoinsel ));
DATA(insert OID = 1800 (  ">="	   PGUID 0 b t f  1136	23  16 1698  97  0  0 int4ge scalargtsel scalargtjoinsel ));
...
DATA(insert OID = 1417 (  "="	   PGUID 0 b t t  23  26  16 1418 0 0 0 int4eqoid eqsel eqjoinsel ));
DATA(insert OID = 1418 (  "="	   PGUID 0 b t t  26  23  16 1417 0 0 0 oideqint4 eqsel eqjoinsel ));

//DATA(insert OID = 957 (  "="	   PGUID 0 b t t  952  26  16 958 608 609 609 longeqoid eqsel eqjoinsel ));
DATA(insert OID = 958 (  "="	   PGUID 0 b t t  26  952  16 957 608 609 609 oideqlong eqsel eqjoinsel ));
...
#ifdef USEGEO
DATA(insert OID = 706 (  "<->"	   PGUID 0 b t f 603 603 701 706   0  0  0 rect_distance - - ));
...
DATA(insert OID =  800 (  ">^"	   PGUID 0 b t f  603  603	 16    0  0 0 0 rect_above positionsel positionjoinsel ));
DATA(insert OID =  801 (  "<^"	   PGUID 0 b t f  603  603	 16    0  0 0 0 rect_below positionsel positionjoinsel ));
DATA(insert OID =  802 (  "?#"	   PGUID 0 b t f  603  603	 16    0  0 0 0 rect_overlap areasel areajoinsel ));
DATA(insert OID =  803 (  "#"	   PGUID 0 b t f  603  603	603    0  0 0 0 rect_intersect - - ));
DATA(insert OID =  804 (  "+"	   PGUID 0 b t f  603  600	603    0  0 0 0 rect_add - - ));
DATA(insert OID =  805 (  "-"	   PGUID 0 b t f  603  600	603    0  0 0 0 rect_sub - - ));
DATA(insert OID =  806 (  "*"	   PGUID 0 b t f  603  600	603    0  0 0 0 rect_mul - - ));
DATA(insert OID =  807 (  "/"	   PGUID 0 b t f  603  600	603    0  0 0 0 rect_div - - ));
...
/*  java operators  */
DATA(insert OID = 2000 (  "instanceof"	  PGUID 0 b t f 1830 1043 16	  0    0	0	 0 java_instanceof - - ));
DATA(insert OID =  2001 ( "="		   PGUID 0 b t f  1830  1830  16  2001 2006  0  0 java_equals eqsel eqjoinsel ));
DATA(insert OID =  2002 ( "<"		   PGUID 0 b t f  1830  1830  16  2003 2005  0  0 java_lt eqsel eqjoinsel ));
DATA(insert OID =  2003 ( ">"		   PGUID 0 b t f  1830  1830  16  2002 2004  0  0 java_gt eqsel eqjoinsel ));
DATA(insert OID =  2004 ( "<="		   PGUID 0 b t f  1830  1830  16  2005 2003  0  0 java_lteq eqsel eqjoinsel ));
DATA(insert OID =  2005 ( ">="		   PGUID 0 b t f  1830  1830  16  2004 2002  0  0 java_gteq eqsel eqjoinsel ));
DATA(insert OID =  2006 ( "<>"		   PGUID 0 b t f  1830  1830  16  2006 2001  0  0 java_noteq eqsel eqjoinsel ));

/*  xid operators  */
DATA(insert OID =  2101 ( "="		   PGUID 0 b t f  28  20  16  2101 2106  0  0 xidint8_equals eqsel eqjoinsel ));
DATA(insert OID =  2102 ( "<"		   PGUID 0 b t f  28  20  16  2103 2105  0  0 xidint8_lt eqsel eqjoinsel ));
DATA(insert OID =  2103 ( ">"		   PGUID 0 b t f  28  20  16  2102 2104  0  0 xidint8_gt eqsel eqjoinsel ));
DATA(insert OID =  2104 ( "<="		   PGUID 0 b t f  28  20  16  2105 2103  0  0 xidint8_lteq eqsel eqjoinsel ));
DATA(insert OID =  2105 ( ">="		   PGUID 0 b t f  28  20  16  2104 2102  0  0 xidint8_gteq eqsel eqjoinsel ));
DATA(insert OID =  2106 ( "<>"		   PGUID 0 b t f  28  20  16  2106 2101  0  0 xidint8_noteq eqsel eqjoinsel ));

DATA(insert OID =  2201 ( "="		   PGUID 0 b t f  28  23  16  2201 2206  0  0 xidint4_equals eqsel eqjoinsel ));
DATA(insert OID =  2202 ( "<"		   PGUID 0 b t f  28  23  16  2203 2205  0  0 xidint4_lt eqsel eqjoinsel ));
DATA(insert OID =  2203 ( ">"		   PGUID 0 b t f  28  23  16  2202 2204  0  0 xidint4_gt eqsel eqjoinsel ));
