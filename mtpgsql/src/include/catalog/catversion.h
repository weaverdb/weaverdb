 ...
 *
 * $Id: catversion.h,v 1.1.1.1 2006/08/12 00:22:10 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef CATVERSION_H
...
#define CATALOG_VERSION_NO_NEW	200707161   /*  for blobstorage changes, for right now, 
                                             *  blobstorage dynamically checks for existence of 
                                             *  new relation
                                             */
