 ...
 *
 * $Id: pg_class.h,v 1.1.1.1 2006/08/12 00:22:12 synmscott Exp $
 *
 * NOTES
...
CATALOG(pg_class) BOOTSTRAP
{
	...
	bool		relhasrules;
	text		relacl;		/* this is here for the catalog */
} FormData_pg_class;
...
DESCR("");
DATA(insert OID = 1628 (  pg_schema 964	  PGUID 0 0 0 0 f t r 5  0 0 0 0 0 f f _null_ ));
DESCR("");
...
DESCR("");
DATA(insert OID = 1835 (  pg_extent 1836	  PGUID 0 0 0 0 t t r 3  0 0 0 0 0 f f _null_ ));
DESCR("");
