...
DATA(insert OID = 406 (  ivfflat PGUID 0 5 1 ivfflatgettuple ivfflatinsert ivfflatdelete ivfflatbulkdelete ivfflatvacuumcleanup - ivfflatrecoverpage ivfflatbeginscan ivfflatrescan ivfflatendscan - - - - ivfflatbuild - - ivfflatcostestimate ));
DESCR("");
#define IVFFLAT_AM_OID 406
DATA(insert OID = 407 (  hnsw PGUID 0 3 1 hnswgettuple hnswinsert hnswdelete hnswbulkdelete hnswvacuumcleanup - hnswrecoverpage hnswbeginscan hnswrescan hnswendscan - - - - hnswbuild - - hnswcostestimate ));
DESCR("");
