...
DATA(insert OID = 2397 (  ivfflat PGUID 0 5 1 ivfflatgettuple ivfflatinsert ivfflatdelete ivfflatbulkdelete ivfflatvacuumcleanup - ivfflatrecoverpage ivfflatbeginscan ivfflatrescan ivfflatendscan - - - - ivfflatbuild - - ivfflatcostestimate ));
DESCR("");
#define IVFFLAT_AM_OID 2397
DATA(insert OID = 2398 (  hnsw PGUID 0 3 1 hnswgettuple hnswinsert hnswdelete hnswbulkdelete hnswvacuumcleanup - hnswrecoverpage hnswbeginscan hnswrescan hnswendscan - - - - hnswbuild - - hnswcostestimate ));
DESCR("");
#define HNSW_AM_OID 2398
