...
#define MCXT_ALLOC_ZERO 0
#endif

#ifndef MemoryContextAllocExtended
#define MemoryContextAllocExtended(ctx, sz, flags) \
	(((flags) & MCXT_ALLOC_ZERO) ? palloc0((sz)) : palloc((sz)))
#endif

#ifndef MemoryContextAllocZero
#define MemoryContextAllocZero(ctx, sz) palloc0((sz))
#endif
