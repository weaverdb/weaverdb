...
#define BM_EXCLUSIVEMASK                          (BM_WRITELOCK | BM_EXCLUSIVE)
#define BM_REMOVEWRITEMASK                          ~(BM_WRITELOCK | BM_EXCLUSIVE)
...
#define BM_READ_IN_PROGRESS			(1 << 8) /* 256 */
#define BM_LOG_IN_PROGRESS			(1 << 9) /*512 */
#define BM_WRITE_IN_PROGRESS			(1 << 10) /*1024 */
...
typedef struct sbufdesc
{
	...
	char*           shadow;			/* pointer to data in buf pool */
        long            generation;
