...
/* Finish a CRC calculation */
#define FINI_CRC64(crc)	((crc).crc0 ^= UINT64CONST(0xffffffffffffffff))
...
PG_EXTERN bool eq_crc64(crc64 c1,crc64 c2);
PG_EXTERN crc64 checksum_block(unsigned char* block,int len);
