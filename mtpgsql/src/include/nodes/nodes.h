 ...
 *
 * $Id: nodes.h,v 1.1.1.1 2006/08/12 00:22:19 synmscott Exp $
 *
 *-------------------------------------------------------------------------
 */
#ifndef NODES_H
 ...
 * nodes/nodes.c
 */
PG_EXTERN Node *newNode(Size size, NodeTag tag);

/*
 * nodes/{outfuncs.c,print.c}
 */
PG_EXTERN char *nodeToString(void *obj);

/*
 * nodes/{readfuncs.c,read.c}
 */
PG_EXTERN void *stringToNode(char *str);

/*
 * nodes/copyfuncs.c
 */
PG_EXTERN void *copyObject(void *obj);

/*
 * nodes/equalfuncs.c
 */
PG_EXTERN bool equal(void *a, void *b);
